...
//	Endpoint para Actualizar un usuario
	...
	@PreAuthorize("hasRole('ADMINISTRADOR')")
	public ResponseEntity<?> actualizarUsuario(@PathVariable Long id_usuario, // Recibe el id_usuario en la URL
...
//	Endpoint para cambiar la contraseña al inicio por primera vez	
	...
	public ResponseEntity<Usuario> cambiarContraseña(@PathVariable Long id, @RequestBody CambioContraseñaDTO dto,
...
//	Endpoint para Obtener imagen	
	...
	public ResponseEntity<?> obtenerImagen(@PathVariable Long id) {
		...
		return ResponseEntity.ok().contentType(MediaType.IMAGE_JPEG) // o IMAGE_PNG si usas PNG
